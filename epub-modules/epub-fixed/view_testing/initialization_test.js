var initializationTest = function (bookType) {
  ...
  else if (bookType === "image") {

    var packageDocumentXML = '<?xml version="1.0" encoding="UTF-8"?> \
<package xmlns="http://www.idpf.org/2007/opf" prefix="cc: http://creativecommons.org/ns# rendition: http://www.idpf.org/vocab/rendition/#" version="3.0" unique-identifier="bookid" xml:lang="fr" dir="ltr" id="package"> \
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/"> \
    <dc:identifier id="bookid">code.google.com.epub-samples.page-blanche_bitmaps-in-spine</dc:identifier> \
      <meta refines="#bookid" property="identifier-type" scheme="onix:codelist5">01</meta> \
      <dc:language>fr</dc:language> \
    <dc:title id="title">Page Blanche (bitmaps directly in spine)</dc:title> \
    <meta refines="#title" property="title-type">main</meta> \
    <dc:creator id="creator1">Boulet</dc:creator> \
    <meta refines="#creator1" property="file-as">Boulet</meta> \
    <meta refines="#creator1" property="role" scheme="marc:relators">aut</meta> \
    ...
    <meta refines="#contributor" property="role" scheme="marc:relators">mrk</meta> \
    <meta refines="#contributor" property="file-as">Gros, Vincent</meta> \
    <meta property="dcterms:modified">2012-08-08T15:00:00Z</meta> \
    <meta property="rendition:layout">pre-paginated</meta> \
    <meta property="rendition:orientation">auto</meta> \
    <meta property="rendition:spread">auto</meta> \
    <meta name="cover" content="cover"/> \
   ...
   <manifest> \
    ...
    <item id="nav" href="Navigation/nav.xhtml" properties="nav" media-type="application/xhtml+xml"/> \
    <item id="ncx" href="Navigation/toc.ncx" media-type="application/x-dtbncx+xml" /> \
      <item id="id-cover-jpg" href="Image/cover.jpg" properties="cover-image" fallback="nav" media-type="image/jpeg"/> \
      <item id="id-PageBlanche_Page_001-jpg" href="Image/PageBlanche_Page_001.jpg" fallback="nav" media-type="image/jpeg"/> \
      <item id="id-PageBlanche_Page_002-jpg" href="Image/PageBlanche_Page_002.jpg" fallback="nav" media-type="image/jpeg"/> \
      <item id="id-PageBlanche_Page_003-jpg" href="Image/PageBlanche_Page_003.jpg" fallback="nav" media-type="image/jpeg"/> \
      <item id="id-PageBlanche_Page_004-jpg" href="Image/PageBlanche_Page_004.jpg" fallback="nav" media-type="image/jpeg"/> \
      <item id="id-PageBlanche_Page_005-jpg" href="Image/PageBlanche_Page_005.jpg" fallback="nav" media-type="image/jpeg"/> \
      <item id="id-PageBlanche_Page_006-jpg" href="Image/PageBlanche_Page_006.jpg" fallback="nav" media-type="image/jpeg"/> \
      <item id="id-PageBlanche_Page_007-jpg" href="Image/PageBlanche_Page_007.jpg" fallback="nav" media-type="image/jpeg"/> \
      <item id="id-PageBlanche_Page_008-jpg" href="Image/PageBlanche_Page_008.jpg" fallback="nav" media-type="image/jpeg"/> \
   </manifest> \
   <spine toc="ncx"> \
      <itemref idref="id-cover-jpg" properties="page-spread-right"/> \
      <itemref idref="id-PageBlanche_Page_001-jpg" properties="page-spread-right"/> \
      <itemref idref="id-PageBlanche_Page_002-jpg" properties="page-spread-left"/> \
      <itemref idref="id-PageBlanche_Page_003-jpg" properties="page-spread-right"/> \
      <itemref idref="id-PageBlanche_Page_004-jpg" properties="page-spread-left"/> \
      <itemref idref="id-PageBlanche_Page_005-jpg" properties="page-spread-right"/> \
      <itemref idref="id-PageBlanche_Page_006-jpg" properties="page-spread-left"/> \
      <itemref idref="id-PageBlanche_Page_007-jpg" properties="page-spread-right"/> \
      <itemref idref="id-PageBlanche_Page_008-jpg" properties="page-spread-left"/> \
   </spine> \
</package>'
  

    var epubParser = new EpubParserModule("epub_content/page-blanche-bitmaps-in-spine-20120809/EPUB/package.opf", packageDocumentXML);
    var packageDocumentObject = epubParser.parse();
    var epub = new EpubModule(packageDocumentObject, packageDocumentXML);
    var spineInfo = epub.getSpineInfo();
    var spineObjects = spineInfo.spine;
